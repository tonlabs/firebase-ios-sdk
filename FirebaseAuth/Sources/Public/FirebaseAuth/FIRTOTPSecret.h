...
/**
 @brief Returns the shared secret key/seed used to generate time-based one-time passcodes.
 */
- (NSString *)sharedSecretKey;

/**
 @brief Returns the hashing algorithm used to generate time-based one-time passcodes.
 */
 ...
 */
- (void) openInTOTPAppWithQRCodeURL:(NSString *)qrCodeURL;
