...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
        name: "FirebaseFirestore",
        url: "https://github.com/ncooke3/binary-firestore/releases/download/0.0.3/FirebaseFirestore.zip",
        checksum: "3f2d5d627790c06a23e3776848563bb9e83ab2b3a4422bb30e025255dc17b16c"
    ),
    .target(
