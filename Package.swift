...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
        name: "FirebaseFirestore",
        url: "https://github.com/ncooke3/binary-firestore/releases/download/0.0.4/FirebaseFirestore.zip",
        checksum: "48470c137d8ab0aa0ac86b5051eb657010bdf2bebea32400a661c23313a5a500"
    ),
    .target(
