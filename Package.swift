...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
        name: "FirebaseFirestore",
        url: "https://github.com/ncooke3/binary-firestore/releases/download/0.0.8/FirebaseFirestore.zip",
        checksum: "d2e3a05b04bd572c8d27c748cd71a6628dd772edde45691c4229fe2936faef3f"
    ),
    .target(
