...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
        name: "FirebaseFirestore",
        url: "https://github.com/ncooke3/binary-firestore/releases/download/0.1.0/FirebaseFirestore.zip",
        checksum: "968e86e67d250473deff21c7fdae3d522ed1a04c3fec93987fa24214ea4858a0"
    ),
    .target(
