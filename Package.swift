...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
        name: "FirebaseFirestore",
        url: "https://github.com/ncooke3/binary-firestore/releases/download/0.0.5/FirebaseFirestore.zip",
        checksum: "77f11e29135bfc8197d8411059ea4770d4cb7adb4bb80a798eb62526b97f915d"
    ),
    .target(
